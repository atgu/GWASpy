...
def joint_pca(
    ...
    pca_scores.export(f'{out_dir}GWASpy/PCA/{data_basename}.1kg_hgdp.joint.pca.scores.txt.bgz')
...
def run_pca_joint(
    ...
    scores_without_pop_label = f'{out_dir}GWASpy/PCA/{data_basename}.1kg_hgdp.joint.pca.scores.txt.bgz'
    ...
    data_pops_df.to_csv(f'{out_dir}GWASpy/PCA/pca_sup_pops_{prob_threshold}_probs.joint.pca.txt', sep='\t', index=False)
